...
function exibeLista() {
	...
	if (lista.status_code < 200 || lista.status_code > 300) {
		...
		sectionPesquisa.innerHTML = `<i class="fa fa-warning"></i> Nenhum conteúdo correspondente encontrado. Tente novamente.`;
		return;
	}
...
xhrPesquisa.open('GET', `${BASE_API_URL}games?search=${query}&key=${apiKey}&page_size=20`);
xhrPesquisa.send();
